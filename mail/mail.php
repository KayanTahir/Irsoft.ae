...
if(!empty($_POST["send"])) {
  ...
  $usercell = $_POST["usercell"];
	...
	$mailHeaders = "Name: IRsoft.ae" . $userName .
  "\r\n phone: ". $usercell  . 
	"\r\n Email: ". $userEmail  . 
	"\r\n Phone: ". $userPhone  . 
	"\r\n Message: " . $userMessage . "\r\n";
	...
	if(mail($toEmail, $userName, $mailHeaders)) {
	    $message = "Your contact information is received successfully.3-day Response Time";
	}
}
?>
  ...
  <form name="contactFormEmail" method="post">
    ...
    <div class="input-row">
     ...
     <div class="input-row">
      ...
      <input type="text" name="usercell" required id="userPhone">
    </div>
    <div class="input-row">
